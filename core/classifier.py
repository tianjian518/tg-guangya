...
_SPECIFIC_KIND_RULES: list[tuple[re.Pattern, str, int]] = [
    ...
    (re.compile(r"动漫|动画|anime|剧场版|\bova\b|\boad\b|番剧|新番|国产动画|日本动画|海贼王|火影忍者|名侦探柯南|哆啦a梦|蜡笔小新|樱桃小丸子|精灵宝可梦|宝可梦|鬼灭之刃|咒术回战|进击的巨人|间谍过家家|葬送的芙莉莲|字幕组|喵萌|诸神|甜梦|动漫花园|巴哈姆特|仙逆|遮天|凡人修仙传|完美世界|吞噬星空|沧元图|师兄太稳健|后西游记|一斩苍穹|师兄啊师兄|大主宰|斗破苍穹|斗罗大陆|武动乾坤|星辰变|雪鹰领主|灵笼|元龙|万界仙踪|武神主宰|牧神记|剑来|长生界|神澜奇域|双生武魂", re.I), KIND_ANIME, 4),
    # 剧集（季集标记）
